...
- [ ] AI-012: 模型配置 - 配置存储到 SQLite | 创建时间: 2026-02-17
- [ ] AI-013: 模型配置 - AI 设置页面完善 | 创建时间: 2026-02-17
...
- [ ] AI-017: LangGraph 智能体 - ReAct Agent 基础实现 | 创建时间: 2026-02-17
- [ ] AI-018: LangGraph 智能体 - Deep Agents 集成 | 创建时间: 2026-02-17
- [ ] AI-019: LangGraph 智能体 - 多轮对话状态管理 | 创建时间: 2026-02-17
- [ ] AI-020: MCP 集成 - MCP 客户端实现 | 创建时间: 2026-02-17
- [ ] AI-021: MCP 集成 - 工具动态注册 | 创建时间: 2026-02-17
- [ ] AI-022: MCP 集成 - MCP 服务器管理 | 创建时间: 2026-02-17
- [ ] AI-023: Skills 系统 - 技能注册机制 | 创建时间: 2026-02-17
- [ ] AI-024: Skills 系统 - 热加载支持 | 创建时间: 2026-02-17
- [ ] AI-025: Skills 系统 - 内置技能实现 | 创建时间: 2026-02-17
...
- [ ] AI-026: 向量存储 - LanceDB 集成 | 创建时间: 2026-02-17
- [ ] AI-027: 文档处理 - 多格式解析 (MD/PDF/TXT) | 创建时间: 2026-02-17
- [ ] AI-028: 文档处理 - 分块策略 | 创建时间: 2026-02-17
- [ ] AI-029: 文档处理 - 嵌入模型集成 | 创建时间: 2026-02-17
- [ ] AI-030: 知识库 UI - 文档管理界面 | 创建时间: 2026-02-17
- [ ] AI-031: 知识库 UI - 配置界面 | 创建时间: 2026-02-17
...
- [ ] AI-032: MCP 管理 UI - MCP 服务器配置界面 | 创建时间: 2026-02-17
- [ ] AI-033: MCP 管理 UI - 工具列表展示 | 创建时间: 2026-02-17
- [ ] AI-034: MCP 管理 UI - 连接状态监控 | 创建时间: 2026-02-17
- [ ] AI-035: Skills 管理 UI - 技能列表 | 创建时间: 2026-02-17
- [ ] AI-036: Skills 管理 UI - 自定义技能上传 | 创建时间: 2026-02-17
- [ ] AI-037: Skills 管理 UI - 技能启用/禁用 | 创建时间: 2026-02-17
...
- [ ] AI-038: 打包部署 - PyInstaller 脚本 | 创建时间: 2026-02-17
- [ ] AI-039: 打包部署 - 自动更新机制 | 创建时间: 2026-02-17
- [ ] AI-040: 聊天界面 - 流式消息显示优化 | 创建时间: 2026-02-17
